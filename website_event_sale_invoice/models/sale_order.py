...
class SaleOrder(models.Model):
    ...
    def _force_lines_to_event_invoice_policy_order(self):
        for line in self.order_line:
            if self.state in ['sale', 'done'] or (line.event_id and line.event_id.online_auto_invoice):
    ...
    def force_quotation_send(self):
        if self.env.context.get('block_force_quotation_send'):
            return True
        else:
            return super(SaleOrder, self).force_quotation_send()
    ...
    def action_invoice_create(self, grouped=False, final=False):
        ...
        for order in self:
            ...
            for line in order.order_line:
                if line.event_id:
                    if not line.event_id.online_auto_invoice:
                        continue
